...
void main() {
  ...
  // Use 0.5 + 0.5 * sin to stretch the pattern down to 0.0 (true black) 
  // and increase the tOffset multipliers so it animates visibly
  float pattern = 0.5 +
...
const Silk = ({ speed = 20, scale = 1, color = '#7B7481', noiseIntensity = 1.5, rotation = 0, lightMode = false }) => {
