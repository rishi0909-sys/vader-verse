...
// Shader code omitted for brevity in replace
const vertexShader = `
...
void main() {
    ...
    if(uChromaticAberration != 0.0 && uQuality > 0.4){
...
export default function FaultyTerminal({
  ...
  const activeDpr = Math.min(dpr ?? (window.devicePixelRatio || 1), profile.dprConfig[1]);
  const activeShaderQuality = profile.shaderQuality * profile.backgroundQuality;
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uQuality: { value: activeShaderQuality }
      }
    });
