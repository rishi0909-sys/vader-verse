...
export const BentoCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none relative z-20 flex transform-gpu flex-col gap-3 sm:gap-5 p-5 sm:p-8 md:p-10 transition-transform duration-700 ease-out group-hover:-translate-y-16">
        
        {/* Header (Icon + Name) */}
        <div className="flex items-center gap-3 sm:gap-5 mb-2 sm:mb-4">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-black/60 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_8px_20px_rgba(0,0,0,0.6)] transition-all duration-700 group-hover:bg-red-600/30 group-hover:border-red-500/50 group-hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.3),0_0_30px_rgba(220,38,38,0.4)] group-hover:-translate-y-1 shrink-0">
            <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-white transition-all duration-700 group-hover:text-red-100 group-hover:scale-110" />
          </div>
          <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-wider sm:tracking-widest uppercase drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] transition-all duration-700 group-hover:text-red-50 truncate sm:overflow-visible sm:whitespace-normal">
            {name}
          </h3>
        </div>
      ...
      {/* CTA Button / Link */}
      <div className="absolute bottom-0 left-0 w-full p-5 sm:p-8 md:p-10 z-30 flex translate-y-12 transform-gpu items-center opacity-0 transition-all duration-700 ease-out group-hover:translate-y-0 group-hover:opacity-100 pointer-events-none">
        <span 
          className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-white bg-red-600/90 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl transition-all shadow-[0_0_15px_rgba(239,68,68,0.2)] group-hover:bg-red-500 group-hover:shadow-[0_0_25px_rgba(239,68,68,0.4)]"
        >
